<x-manage-layout>
    ...
    <div class="max-w-4xl mx-auto mt-3">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-2xl font-black text-gray-900">People you follow</h1>
                <p class="text-gray-500 text-sm">You are currently following {{ $followings->count() }} creators</p>
            </div>
        ...
        <div class="flex flex-col gap-4">
            ...
            @foreach ($followings as $following)
                <x-following-card-wide :following="$following" />
            @endforeach
